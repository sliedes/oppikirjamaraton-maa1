...
\begin{itemize}
% FIXME onko kertomerkin poisjättäminen (ab) tuttu merkintätapa?
...
% FIXME sama laatikko on jo yllä! (toistoa)
...
Esimerkiksi seuraava laskutoimitus on helppo laskea osittelulain avulla: $2574\cdot 542-2574\cdot 541 = 2574\cdot (542-541) = 2574\cdot 1 = 2574$
...
\end{tehtava}
    ...
    \begin{tehtava}
    Mitkä seuraavista luvuista ovat jaollisia luvulla $4$? Jos luku $a$ on jaollinen luvulla $4$, kerro, mille kokonaisluvulle $b$ pätee $a = 4 \cdot b$.\\
