...
Laskutoimitusten ja muun matemaattisen pohdinnan merkitseminen kirjalliseen muotoon on taito, jonka oppiminen oli merkittävä askel ihmisen kehityshistoriassa. Aikojen saatossa eri kansat ovat käyttäneet erilaisia tapoja merkitä laskutoimituksia ja lukumääriä. Tunnettu esimerkki on roomalaiset numerot, jotka näyttävät hyvin erilaisilta kuin nykyään käyttämämme lukumerkinnät.
...
\begin{esimerkki}
\begin{itemize} % FIXME ensimmäinen itemi menee ''Esimerkki.'' -tekstin perään
\item III$=1+1+1=3$
\item IX$=10-1=9$
\item XII$=10+1+1=12$
\item XIX$=10+(10-1)=19$
\item CDX$=500-100+10=410$
% FIXME annettu kuvaus ja seuraava esimerkki itse asiassa on väärin;
% V:tä, L:ää ja D:tä ei koskaan vähennetä. Luku 1600 esitetään MDC.
% Ainakin yleisimmässä tavassa käyttää roomalaisia numeroita.
\item MDMC$=1~000+(1~000-500)+100=1~600$
\end{itemize}
\end{esimerkki}
